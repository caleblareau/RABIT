...
quantile_transform <- function(dst, src, N) {
    invisible(.Call('RABIT_quantile_transform', PACKAGE = 'RABIT', dst, src, N))
}

normal_transform <- function(dst, src, N) {
    invisible(.Call('RABIT_normal_transform', PACKAGE = 'RABIT', dst, src, N))
}

Benjamini_Hochberg <- function(FDR, pvalue, N) {
    invisible(.Call('RABIT_Benjamini_Hochberg', PACKAGE = 'RABIT', FDR, pvalue, N))
}

triangle_index <- function(i, j) {
    .Call('RABIT_triangle_index', PACKAGE = 'RABIT', i, j)
}
