...
// allocate the internal variable space
FWL_space * FWL_space_alloc(size_t p, size_t n, size_t m, size_t k)
{
...
Forward_space * Forward_space_alloc(size_t p, size_t n)
{
	Forward_space *r = (Forward_space*)malloc(sizeof(Forward_space));

	r->X_t = gsl_matrix_alloc(p, n);
